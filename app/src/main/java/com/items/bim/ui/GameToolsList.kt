...
import com.items.bim.common.ui.TopPagerList
...
fun GameToolsList(
    ...
    if(toolsViewModel.pool.isEmpty()){
        Utils.message(rememberCoroutineScope(), "暂无支持游戏", SystemApp.snackBarHostState)
    }else{
        TopPagerList(
            modifier = modifier
